...
{
    class NotApprowedObjectsFound : Exception, ConcreteException
    {
        public NotApprowedObjectsFound() : base() { }

        public NotApprowedObjectsFound(string message) : base(message) { }

        public void processing(Exception ex)
        {
            ExceptionViewInterface<ErrorPopupWindowConfig> view = new ErrorPopupWindow();
            ErrorPopupWindowConfig config = new ErrorPopupWindowConfig(Message);
