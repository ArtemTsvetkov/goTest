...
{
    class DeleteTestView : NavigatorsView, Observer
    {
        private Form1 form;
        private GoTestAdapterI adapter;
        private BasicModel<List<Subject>, List<Subject>> model;

        public DeleteTestView(Form1 form, GoTestAdapterI adapter,
        ...
        public void show()
        {
            form.tabControl1Elem.SelectTab(12);
        }
        ...
        public void reset()
        {
            form.comboBox7Elem.SelectedIndex = -1;
            form.comboBox7Elem.SelectedText = "";
            form.comboBox7Elem.Items.Clear();
            form.comboBox8Elem.SelectedIndex = -1;
            form.comboBox8Elem.SelectedText = "";
            form.comboBox8Elem.Items.Clear();
        }
            ...
            if (Navigator.Navigator.getInstance().getCurrentViewsName().Equals(getName()))
            {
                ...
                for (int i = 0; i < subjects.Count; i++)
                {
                    for (int s = 0; s < subjects.Count; s++)
                    {
                        ...
                        {
                            form.comboBox7Elem.Items.Add(subjects.ElementAt(i).Name);
                        }
                    }
                }
            }
